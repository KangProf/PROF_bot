...
*/
const PROF = '💢PROF-ACC💢'; // Nama Bot Whatsapp
...
conn.sendMessage(id, 'utamakan salam kak, Ketik .help/.info/.donasi Contoh .help' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'utamakan salam kak, Ketik .help/.info/.donasi Contoh .help' ,MessageType.text);
}
...
conn.sendMessage(id, 'Owner PROF-ACC wa.me/+6281326977165' ,MessageType.text);
}
else if (text == 'prof'){
...
//Tolonglah bro jangan di ubah ubah PROF
